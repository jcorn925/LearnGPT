...
import { isBraveBrowser, shouldShowRatingTip } from '@Utils/utils'
...
function ChatGPTQuery(props: Props) {
  ...
  const [currentRenderMethod, setCurrentRenderMethod] = useState(currentRenderer);
  ...
  useEffect(() => {
    console.log(currentRenderMethod, 'currentRenderMethod');
  });
